...
test('service worker never caches private cross-origin API responses', async () => {
  ...
  expect(serviceWorker).toContain("const CACHE_NAME = 'timekeeper-app-v44';");
  expect(serviceWorker).toContain("'./src/main.mjs?v=39'");
  expect(serviceWorker).toContain(
  ...
  expect(mainSource).toContain(".register('./service-worker.js?v=44')");
});
