...
const CACHE_NAME = 'timekeeper-app-v62';
const APP_SHELL = [
  './',
  './index.html',
  './codex-analysis.html',
  './style.css?v=49',
  './src/main.mjs?v=57',
  './src/features/claude/policy.mjs',
  './src/features/claude/inbox.mjs',
  ...
  './src/features/codex/policy.mjs',
  './src/features/codex/revaluation.mjs',
  './src/shared/runtime-helpers.mjs',
  './src/shared/id.mjs',
  './src/shared/profile-storage.mjs',
  './src/shared/profile-compression-worker.mjs',
  './src/shared/vendor/lz-string.mjs',
  './src/shared/ui.mjs',
  ...
  './src/styles/base.css',
  './src/styles/components.css?v=49',
  './src/styles/features.css?v=49',
    ...
    caches
      ...
      .then((clients) => {
        ...
        clients.forEach((client) => {
          ...
          if (url.searchParams.get('timekeeper-update') === '62') return;
